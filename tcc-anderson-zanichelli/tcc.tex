...
\begin{document}
    ...
    \input{conteudo/capitulo1}
    \input{conteudo/capitulo2}
    \input{conteudo/capitulo3}
    \input{conteudo/capitulo4}
    \input{conteudo/capitulo5}
    \input{conteudo/capitulo6}
    \input{conteudo/capitulo7}
    \input{conteudo/capitulo8}
    % Aqui começa a bibliografia da monografia
    \bibliographystyle{abnt-alf}
    \bibliography{abnt-uem}
    % Apêndice e Anexos
    \apendice
